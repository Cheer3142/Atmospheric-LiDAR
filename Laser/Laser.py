...
# UI Frequency
frequency_label = tk.Label(setting_control_frame, text="Frequency (1-20Hz)",bg='#B8BBBF')
...
warning_label = tk.Label(root, text="Contact Ruslan Tayae for the compensation cost.", font=("Arial", 12), pady=10,fg='red',bg='#B8BBBF')
